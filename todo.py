...
if __name__ == "__main__":  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#bef7fa")  
    functions_frame = tk.Frame(guiWindow, bg = "#bef7fa")  
    listbox_frame = tk.Frame(guiWindow, bg = "#bef7fa")  
